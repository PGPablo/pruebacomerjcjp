...
export const crearNoticiasAction = (noticiaData) => async (dispatch) => {
    ...
    try {
        const imagenRef = await storage.ref().child('img_noticias').child(noticiaData.imagenurl.name)
        await imagenRef.put(noticiaData.imagenurl)

        const imagenURL = await imagenRef.getDownloadURL()
        noticiaData.imagenurl = imagenURL
...
export const modificarNoticiasAction = (noticiaData, id) => async (dispatch) => {
    ...
    let imagenURL = noticiaData.imagenurl
